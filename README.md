...
## Neovim plugin (`k1.nvim`)

This repo now includes a minimal Neovim plugin for `k1` LSP:
- `tools/nvim/lua/k1/init.lua`
- `tools/nvim/plugin/k1.lua`
- `tools/nvim/ftdetect/k1.lua`
- `tools/nvim/ftplugin/k1.lua`
...
- `:K1LspStart` starts (or reuses) a matching `k1-lsp` client
- `:K1LspStart!` forces a new client
- `:K1LspRestart` restarts all `k1-lsp` clients
