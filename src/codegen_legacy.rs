...
use crate::ast::{BlockStmt, ConstVal, Definition, Expression, Literal, Module, TypeExpression, TypePrimitive, ValDef};
...
impl<'ctx> CodeGen<'ctx> {
    ...
    fn get_basic_metadata_ty(&self, expr: &TypeExpression) -> BasicMetadataTypeEnum {
        match expr {
            Primitive(TypePrimitive::Int) => BasicMetadataTypeEnum::IntType(self.context.i32_type()),
        }
    }
