...
impl IdentPool {
    ...
    pub fn make(mem: &mut Mem<ParsedProgram>) -> Self {
        ...
        let b = BuiltinIdents {
            ...
            iterable_var: intern!("__iterable"),
            opt: intern!("opt"),
